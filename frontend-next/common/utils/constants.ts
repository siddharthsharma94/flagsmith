...
export const Constants = {
    ...
    events: {
        ...
        'ACCEPT_INVITE': (org:string) => ({ 'event': 'Invite accepted', 'category': 'Invite', extra: org }),
        'LOGIN_DEMO': { 'event': 'User demo login', 'category': 'User' },
        'LOGIN': { 'event': 'User login', 'category': 'User' },
        'OAUTH': (type:string) => ({ 'event': `User oauth ${type}`, 'category': 'User' }),
    ...
    environmentPermissions: (perm:string) => `To use this feature you need the <i>${perm}</i> permission for this environment.<br/>Please contact a member of this environment who has administrator privileges.`,
    organisationPermissions: (perm:string) => `To use this feature you need the <i>${perm}</i> permission for this organisation.<br/>Please contact a member of this organisation who has administrator privileges.`,
    pages: {
    ...
    codeHelp: {
        ...
        'INIT': (envId:string, flagName:string) => ({
